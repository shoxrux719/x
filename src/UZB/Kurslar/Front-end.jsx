...
>
        ...
        <section className='bg-purple-600 my-6 ml-[68px] rounded-[17.96px] w-[1300px] h-[228.18px] text-white animate-fadeIn'>
          <div className='mx-auto px-12 container'>
            ...
            Kim <span className='text-purple-300'>Frontend</span>-dasturchi?
            </h2>
            <p className='mt-4'>
            O'zbekistonda eng ko'p talab qilinadigan mutaxassislardan biri, u:
            </p>
            <ul className='space-y-2 mt-4'>
              <li>Frontend Dasturlash - bu yaratishni o'zlashtirish uchun mo'ljallangan intensiv va amaliyotga yo'naltirilgan kurs <br />
              dinamik va interaktiv veb-sahifalar. Kurs HTML, CSS va JavaScript-dan barcha texnologiyalarni o'z ichiga oladi <br />
              
ishtirokchilar front-end rivojlantirish sohasida yuqori malakali mutaxassislarga aylanadi.</li>
        ...
        <section className='bg-white h-[300px]'>
          ...
          <div className='text-right pr-[145px]'>
            ...
            Ushbu kurs oldingi sohada muvaffaqiyatli martaba sari qadam bo'ladi. <br />
            nafaqat bilimlarni, balki haqiqiy ko'nikmalarni ham ta'minlaydigan rivojlanish, <br />
            kasbiy faoliyatda qo'llaniladi.
            </p>
            <p className='text-right font-medium text-[17.96px] leading-[26.93px]; @apply'>
            Sertifikatlash va portfolio: Kursni tugatgandan keyin sertifikat berish, <br /> 
            ko'nikma va bilimlarni tasdiqlash. IT sohasida martaba uchun professional portfelni yaratishda murabbiylardan yordam.
            </p>
          </div>
        </section>
                  ...
                  <div className='top-[10%] left-[2%] absolute'>
                    <table className='border-white bg-black mt-[65px] ml-[50px] border text-white'>
                      ...
                      <tr>
                        ...
                        <th className='border-white border'>5 oygacha</th>
