...
const AiUz = ({ isDarkMode }) => {
  ...
  className="flex h-[600px] items-center gap-[102px] bg-custom-background mx-auto px-4 pl-[119px] text-center animate-fadeInUp container"
>
            <p className='font-medium text-[74px] text-left text-white leading-[112.22px]'>
          Suniy intelektlar
            </p>
            <div
              className='bg-cover bg-center w-[864.85px] h-[484.05px] animate-scaleIn'
              style={{
                backgroundImage: "url('/public/img/Ai.png')"
              }}
            ></div>
          </div>
        </section>
        ...
        <section className='bg-purple-600 my-6 ml-[68px] rounded-[17.96px] w-[1300px] h-[228.18px] text-white animate-fadeIn'>
          <div className='mx-auto px-12 container'>
            ...
            Katta ma'lumotlarni tahlil qilish, sinovdan o'tkazish va muammolarni hal qilish
            </h2>
            <p className='mt-4'>
            Sanoatda sun'iy intellektni qo'llashning jadal o'sishini hisobga olgan holda, ushbu sohadagi mutaxassislar tobora ortib bormoqda. <br />
            talabda. Bizning kursimiz nafaqat nazariy bilimlarni, balki sizni amalga oshiradigan amaliy ko'nikmalarni ham taklif etadi <br />
            mehnat bozorida raqobatbardosh.
            </p>
        ...
        <section className='bg-white h-[300px]'>
          ...
          <div className='text-right pr-[145px]'>
            ...
            Tartibsiz ma'lumotlarni tozalang, naqsh va tushunchalarni aniqlang va <br />
           
topilmalaringizni baham ko'ring. Ushbu o'rta darajadagi dastur o'z ichiga oladi <br />
o'zingizning to'plamlaringizni tanlaydigan haqiqiy loyihalar <br />
ma'lumotlar, tadqiqot savollari va tahlil yondashuvi.
            </p>
