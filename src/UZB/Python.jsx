...
>
        ...
        {/* Описание профессии */}
        <section className='bg-purple-600 pt-[100px] my-6 ml-[68px] rounded-[17.96px] w-[1300px] h-[228.18px] text-white animate-fadeIn'>
              ...
              <div className='relative mr-auto mb-[165px] ml-auto w-[1200px] m'>
                ...
                <div>
                  ...
                  <div className='top-[10%] left-[2%] absolute'>
                    <table className='border-white bg-black mt-[65px] pl-[70px] border text-white'>
                      <tr>
                        <th></th>
                      ...
                      <tr>
                        ...
                        <th className='border-white border'>64 dars</th>
