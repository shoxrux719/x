                  ...
                  <div className='top-[10%] left-[2%] absolute'>
                    <table className='border-white bg-black  mt-[65px] ml-[50px] border text-white'>
                      ...
                      <tr>
                        ...
                        <th className='border-white border'> 8месяцев</th>
                        <th className='border-white border'>64 урока</th>
                        <th className='border-white border'>1 400 000</th>
                      ...
                      <tr>
                        ...
                        <th className='border-white p-[18px] border'>922 833</th>
                      </tr>
                      <tr>
                        ...
                        <th className='border-white border'>48 уроков</th>
                        <th className='border-white border'></th>
                      ...
                      <tr>
                        ...
                        <th className='border-white p-[20px] border'>8-12 месяцев</th>
                        <th className='border-white p-[20px] border'></th>
                        <th className='border-white p-[20px] border'></th>
                        <th className='border-white p-[20px] border'>922 833</th>
                      </tr>
                      <tr>
                        ...
                        <th className='border-white p-[20px] border'>1 800 000</th>
                        <th className='border-white p-[20px] border'></th>
                      </tr>
                      <tr>
                        ...
                        <th className='border-white p-[20px] border'>64 урока</th>
                      ...
                      <tr>
                        ...
                        <th className='border-white p-[20px] border'>6 месяцев</th>
                        <th className='border-white p-[20px] border'>72 урока</th>
                        <th className='border-white p-[20px] border'>1 500 000</th>
                        <th className='border-white p-[20px] border'></th>
                      </tr>
                    </table>
                  </div>
