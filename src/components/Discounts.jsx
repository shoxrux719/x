...
const Discounts = () => {
  return (
   <>
   <div>
    <h2 className=" text-[40.24px] font-bold leading-[48.29px] text-center dark:text-white mb-[30px]">Chegirma va Aksiyalar</h2>
    ...
    <div className="flex gap-[12px] mb-[12px]">
        ...
        <div>
            ...
            <p className="text-[15.4px] font-medium leading-[20.79px] text-left mb-[24px] dark:text-white"> Roʻyxatdan oʻtishga shoshiling!</p>
            <p className=" text-[10.26px] font-medium leading-[12.73px] tracking-[0.01em] text-left dark:text-white">Axborot <br />texnologiyasiga qiziquvchilar bizning <br /> akademiyalarimizda <br />unutilmas hafta o'tkazadilar
            </p>
        </div>
    </div>
   </div>
  ...
  <p className="text-[35.93px] pl-[35px] font-semibold leading-[38.49px] tracking-[-0.03em] text-left text-white">
    Dekabr oyidagi  kurslarga yoziling
  </p>
